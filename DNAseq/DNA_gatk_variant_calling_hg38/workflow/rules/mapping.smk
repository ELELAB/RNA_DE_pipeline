...
#        idx="resources/genome.fasta", "resources/genome.amb", "resources/genome.ann", "resources/genome.bwt", "resources/genome.pac", "resources/genome.sa", "resources/genome.alt",
    output:
...
#        known_idx="resources/variation.noiupac.vcf.gz.tbi",
        known="resources/gatk_bundle/Homo_sapiens_assembly38.dbsnp138.vcf",
        known_idx="resources/gatk_bundle/Homo_sapiens_assembly38.dbsnp138.vcf.idx",
    output:
