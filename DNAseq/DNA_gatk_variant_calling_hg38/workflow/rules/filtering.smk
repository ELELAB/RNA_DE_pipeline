...
rule recalibrate_calls_snvs:
    input:
        ...
        ref="resources/genome.fasta",
        hapmap="resources/gatk_bundle/hapmap_3.3.hg38.vcf.gz",
        omni="resources/gatk_bundle/1000G_omni2.5.hg38.vcf.gz",
        g1k="resources/gatk_bundle/1000G_phase1.snps.high_confidence.hg38.vcf.gz",
        dbsnp="resources/gatk_bundle/Homo_sapiens_assembly38.dbsnp138.vcf.gz"
    output:
...
rule recalibrate_calls_indels:
    input:
        ...
        ref="resources/genome.fasta",
        mills="resources/gatk_bundle/Mills_and_1000G_gold_standard.indels.hg38.vcf.gz",
        axiomPoly="resources/gatk_bundle/Axiom_Exome_Plus.genotypes.all_populations.poly.hg38.vcf.gz",
        dbsnp="resources/gatk_bundle/Homo_sapiens_assembly38.dbsnp138.vcf.gz",
    output:
